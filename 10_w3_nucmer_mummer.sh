...
#SBATCH --output=/data/users/trakic/assembly_annotation_course/output_err/output_mummer_%j.o
#SBATCH --error=/data/users/trakic/assembly_annotation_course/output_err/error_mummer_%j.e

WORKDIR=/data/users/trakic/assembly_annotation_course
OUTDIR=$WORKDIR/results/week3_nucmer_mummer
